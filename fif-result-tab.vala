/*
* Copyright (C) 2015 The Lemon Mank
*
...
namespace GeditFindInFilesPlugin {
    ...
    class ResultTab : Overlay {
        ...
        private bool list_search (TreeModel model, int column, string key, TreeIter iter) {
            ...
            if (Posix.strstr (val.get_string (), key) != null)
                return false;
            else
                return true;
        }
        ...
        private bool on_button_press (Gdk.EventButton event) {
            ...
            if (event.type == Gdk.EventType.BUTTON_PRESS && event.button == 3) {
                ...
                var close_item = new Gtk.MenuItem.with_mnemonic ("_Close");
        ...
        public ResultTab.for_job (FindJob job_, string root_, Gedit.Window win_) {
            ...
            job.on_search_finished.connect (() => {
                ...
                if (!results_model.get_iter_first (out dummy)) {
                    ...
                    results_model.set (dummy, 0, "No results found");
                }
            });
